...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/etc/permissions/tablet_core_hardware.xml)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/etc/permissions/dragon_features.xml)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/etc/permissions/android.hardware.camera.raw.xml)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/etc/permissions/android.hardware.location.gps.xml)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/etc/permissions/android.hardware.camera.full.xml)
